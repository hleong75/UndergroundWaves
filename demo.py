...
def main():
    ...
    print("  - Wheel-rail friction sounds (NEW!)")
    print()
    ...
    print("  ✓ Rail joint clicks (clickety-clack) - NEW!")
    print("  ✓ Wheel flange squeal on curves - NEW!")
    print("  ✓ Brake squeal - NEW!")
    print("  ✓ Low-speed grinding - NEW!")
    print("  ✓ Wheel slip sounds - NEW!")
